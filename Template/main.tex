...
%------------------------------------------------------------------------------
% CHAPITRES SUPPLÉMENTAIRES (COMMENTÉS PAR DÉFAUT)
%------------------------------------------------------------------------------
% Décommentez ces lignes et créez les fichiers correspondants pour ajouter des chapitres
% \input{content/chapters/chapitre1.tex}
% \input{content/chapters/chapitre2.tex}
% \input{content/chapters/chapitre3.tex}
...
% Alternative pour natbib (décommentez si vous utilisez natbib)
% \bibliography{assets/bibliography/references}

%------------------------------------------------------------------------------
% PAGES FINALES
%------------------------------------------------------------------------------
% Décommentez ces lignes et créez les fichiers correspondants pour ajouter des pages finales
% \appendix  % Début des annexes
% \input{content/backmatter/annexe_a.tex}
% \input{content/backmatter/annexe_b.tex}
