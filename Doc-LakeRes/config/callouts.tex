...
\tcbset{
    callout/.style={
        ...
        left skip=0.5cm,    % Décalage à gauche
        right skip=0cm,   % Décalage à droite (pour équilibrer)
    }
}
